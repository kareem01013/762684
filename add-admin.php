<?php
    ...
    if($lastInsertId){
    $msg="تم اضافة المسؤول الجديد بنجاح";
    } else {
    $error="ERROR";
    }
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">اضافة مسؤول جديد</h4>
                            <ul class="breadcrumbs pull-right"> 
                                <li><a href="manage-admin.php">ادارة المسؤولين </a></li>
                                <li><span>اضافة مسؤول جديد</span></li>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>رسالة: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">يرجى ملء النموذج لإضافة مسؤول نظام جديد</p>
                                    

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">الاسم الكامل</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">اسم المستخدم</label>
