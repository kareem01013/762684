                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">طلبات قيد الانتظار</h4>
                            <ul class="breadcrumbs pull-right">
                                <li><a href="dashboard.php">الرئيسية</a></li>
                                <li><span>طلبات الاجازة التي قيد المراجعة</span></li>
                                    ...
                                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->PostingDate);?></td>
                                                ...
                                                if($stats==1){
                                             ?>
                                                 <span style="color: green">تم الموافقة <i class="fa fa-thumbs-o-up"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">مرفوضة <i class="fa fa-thumbs-o-down"></i></span>
                                                 <?php } if($stats==0)  { ?>
