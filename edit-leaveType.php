                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">الاجازات</h4>
                            <ul class="breadcrumbs pull-right">
                                <li><a href="leave-section.php">نوع الاجازات</a></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>رسالة: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">يرجى إجراء تغييرات على النموذج أدناه لتحديث نوع الاجازة</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">الوصف</label>
