                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">تحديث بيانات الموظفين</h4>
                        </div>
                    </div>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>رسالة: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">يرجى إجراء تغييرات على النموذج أدناه لتحديث ملف الموظف</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">العنوان</label>
