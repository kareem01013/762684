                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-center">تفاصيل طلب الاجازة</h4>
                    ...
                    <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>رسالة: </strong><?php echo htmlentities($error); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if($stats==1){
                                ?>
                                    <span style="color: green">تم الموافقة</span>
                                    <?php } if($stats==2)  { ?>
                                ...
                                <tr>
                                     <td ><b>سبب الاجازة: </b></td>
                                     <td colspan="5"><?php echo htmlentities($result->Description);?></td>
                                          
                                </tr>

                                <tr>
                                    <td ><b>ملاحظة المسؤول: </b></td>
                                    <td colspan="12"><?php
                                ...
                                <tr>
                                <td ><b>تاريخ مراجعة المسؤول للطلب: </b></td>
                                    <td><?php
                                    if($result->AdminRemarkDate==""){
                                    echo "الطلب قيد المراجعة الان ";  
                                    }
                                    else{
                            ...
                            <tr>
                            <td colspan="12">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">الاجابة على الطلب</button>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">الاجابة على الطلب</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <p><textarea id="textarea1" name="description" class="form-control" name="description" placeholder="يرجى كتابة ملاحظة لصاحب الطلب" row="5" maxlength="500" required></textarea></p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-dismiss="modal">الغاء</button>
                                    <button type="submit" class="btn btn-success" name="update">اضافة</button>
                                </div>
                                </div>
                            </div>
                            </div>
