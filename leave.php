                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>رسالة: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">نموذج طلب اجازة </h4>
                                        <p class="text-muted font-14 mb-4">يرجى ملئ النموذج ادنى </p>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">تاريخ بداء الاجازة</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">اكتب سبب الاجازة او ملاحظة</label>
                                            <textarea class="form-control" name="description" type="text" name="description" length="400" id="example-text-input" rows="5"></textarea>
                                        </div>

                                        <button class="btn btn-primary" name="apply" id="apply" type="submit">ارسال </button>
