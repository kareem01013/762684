                ...
                <form name="signin" method="POST">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="signin">دخول <i class="ti-arrow-right"></i></button>
                            
                        </div>
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="../index.php"><i class="ti-arrow-left"></i> العودة الى الصفحة الرئيسية</a></p>
                        </div>
                    </div>
                </form>
            </div>
