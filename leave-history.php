...
<head>
    ...
    <title>جميع طلبات الاجازة</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">جميع طلبات الاجازة</h4>
                            <ul class="breadcrumbs pull-right">
                                <li><a href="dashboard.php">الرئيسية</a></li>
                                <li><span>جميع الطلبات</span></li>
                                 ...
                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="employeeLeave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="btn btn-secondary btn-sm">عرض تفاصيل اكثر</a></td>
                                            </tr>
                                                <?php $cnt++;} }?>
                                            </tbody>
                                                </table>
