                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="#">
                                <a href="leave.php" aria-expanded="true"><i class="ti-user"></i><span>طلب اجازة
                            </li>

                            <li class="#">
                                <a href="leave-history.php" aria-expanded="true"><i class="ti-agenda"></i><span>عرض جميع اجازاتي 
                                    </span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">حسابي </h4>  
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>رسالة: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">تحديث بيانات الحساب</h4>
                                        <p class="text-muted font-14 mb-4">يرجى إجراء تغييرات على النموذج أدناه لتحديث ملف التعريف الخاص بك</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">الاسم</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">اختار قسم العمل</label>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">تحديث</button>
