<?php
    ...
    if(isset($_POST['signin']))
    {
        ...
        if($query->rowCount() > 0)
        {
            ...
            if($status==0)
        {
            $msg="حساب غير نشط. الرجاء الاتصال بالمسؤول!";
        } else  {
            $_SESSION['emplogin']=$_POST['username'];
            echo "<script type='text/javascript'> document.location = 'employees/leave.php'; </script>";
        }
            }   else  {
                echo "<script>alert('عذرا ، تفاصيل غير صحيحة.');</script>";
                }
...
<head>
    ...
    <title>لوحة تسجيل دخول الموظف</title>
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="row mb-4 rmber-area">
                            ...
                            <div class="col-6 text-right">
                                <a href="password-recovery.php">هل نسيت كلمة المرور?</a>
                            </div>
                        </div>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="admin/index.php">الذهاب الى لوحة تحكم المسؤول</a></p>
                        </div>
                    </div>
                </form>
            </div>
